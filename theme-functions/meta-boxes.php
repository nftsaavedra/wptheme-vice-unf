...
function viceunf_evento_metabox_html($post) {
    ...
    ?>
    <style>.evento-metabox-field{margin-bottom:15px;}.evento-metabox-field label{display:block;font-weight:bold;margin-bottom:5px;}.evento-metabox-field input{width:100%;max-width:300px;}</style>
