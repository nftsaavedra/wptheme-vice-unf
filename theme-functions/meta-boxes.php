...
?>
    ...
    <div class="slider-metabox-section">
        ...
        <div class="slider-field"><label for="slider_link_type">Tipo de Enlace para Botón 1</label><select id="slider_link_type" name="slider_link_type">
