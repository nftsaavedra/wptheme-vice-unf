 ...
 * =================================================================
 * Este archivo ha sido refactorizado para usar `VpinUnf_Metabox_Factory`.
...
add_action("{$taxonomy_slug}_add_form_fields", 'vpinunf_add_category_meta_fields');
function vpinunf_add_category_meta_fields()
{
?>
    <div class="form-field term-color-wrap">
        <label for="term_meta_color">Color de la Categoría</label>
        <input type="text" name="term_meta[color]" id="term_meta_color" class="vpinunf-color-picker" value="#CCCCCC">
        <p class="description">Selecciona un color para representar esta categoría.</p>
    </div>
<?php
}

add_action("{$taxonomy_slug}_edit_form_fields", 'vpinunf_edit_category_meta_fields');
function vpinunf_edit_category_meta_fields($term)
{
...
?>
    <tr class="form-field term-color-wrap">
        ...
        <td>
            <input type="text" name="term_meta[color]" id="term_meta_color" class="vpinunf-color-picker" value="<?php echo esc_attr($color); ?>">
            <p class="description">Selecciona un color para representar esta categoría.</p>
        </td>
    </tr>
<?php
...
add_action("edited_{$taxonomy_slug}", 'vpinunf_save_category_meta');
add_action("create_{$taxonomy_slug}", 'vpinunf_save_category_meta');
function vpinunf_save_category_meta($term_id)
{
