...
function viceunf_register_post_types() {
    // --- CPT: Slider ---
    $slider_labels = array(
        'name'                  => _x( 'Sliders', 'Post Type General Name', 'viceunf' ),
        'singular_name'         => _x( 'Slider', 'Post Type Singular Name', 'viceunf' ),
        'menu_name'             => __( 'Sliders', 'viceunf' ),
        'add_new_item'          => __( 'Añadir Nuevo Slider', 'viceunf' ),
        'edit_item'             => __( 'Editar Slider', 'viceunf' ),
        'featured_image'        => __( 'Imagen de Fondo', 'viceunf' ),
        'set_featured_image'    => __( 'Establecer Imagen de Fondo', 'viceunf' ),
        'remove_featured_image' => __( 'Quitar Imagen de Fondo', 'viceunf' ),
        'use_featured_image'    => __( 'Usar como Imagen de Fondo', 'viceunf' ),
    );
    $slider_args = array(
        'label'               => __( 'Slider', 'viceunf' ),
        'description'         => __( 'Contenido para el slider principal', 'viceunf' ),
    ...
    // --- CPT: Evento ---
    $evento_labels = array(
        'name'          => _x( 'Eventos', 'Post Type General Name', 'viceunf' ),
        'singular_name' => _x( 'Evento', 'Post Type Singular Name', 'viceunf' ),
        'menu_name'     => __( 'Eventos', 'viceunf' ),
        'all_items'     => __( 'Todos los Eventos', 'viceunf' ),
        'add_new_item'  => __( 'Añadir Nuevo Evento', 'viceunf' ),
        'edit_item'     => __( 'Editar Evento', 'viceunf' ),
    );
    $evento_args = array(
        'label'              => __( 'Evento', 'viceunf' ),
        'description'        => __( 'Contenido para la sección de eventos', 'viceunf' ),
        'labels'             => $evento_labels,
    ...
    register_taxonomy( 'categoria_reglamento', array( 'reglamento' ), $categoria_args );
}
