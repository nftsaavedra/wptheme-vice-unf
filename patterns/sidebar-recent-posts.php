...
<div class="wp-block-group has-white-background-color has-background">
    ...
    <!-- wp:heading {"level":4,"style":{"typography":{"fontSize":"var:preset|font-size|md"}},"textColor":"vpinunf-primary"} -->
    <h4 class="wp-block-heading has-vpinunf-primary-color has-text-color">Entradas Recientes</h4>
    <!-- /wp:heading -->

    <!-- wp:separator {"backgroundColor":"vpinunf-secondary","style":{"layout":{"selfStretch":"fixed","flexSize":"48px"}}} -->
    <hr class="wp-block-separator has-text-color has-vpinunf-secondary-color has-alpha-channel-opacity has-vpinunf-secondary-background-color has-background"/>
    <!-- /wp:separator -->
        ...
        <!-- wp:post-template -->
            ...
            <div class="wp-block-group">
                ...
                <div class="wp-block-group">
                    ...
                    <!-- wp:post-date {"style":{"typography":{"fontSize":"var:preset|font-size|xs"}},"textColor":"vpinunf-legacy-pri2"} /-->
                </div>
                <!-- /wp:group -->
            </div>
            <!-- /wp:group -->
