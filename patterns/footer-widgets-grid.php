 ...
 * Slug: viceunf/footer-widgets-grid
 * Description: Pie de página institucional en 4 columnas — equivalente FSE-nativo a los footer widgets clásicos.
 * Categories: viceunf-blocks, footer
 * Keywords: footer, pie, institucional, widgets, columnas, viceunf
 * Block Types: core/template-part
 * Inserter: true
 */
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|50"}}},"backgroundColor":"viceunf-primary","textColor":"white","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-viceunf-primary-background-color has-white-color has-text-color has-background">
    ...
    <div class="wp-block-columns">
        ...
        <div class="wp-block-column" style="flex-basis:23.33%">
            <!-- wp:heading {"level":5,"style":{"typography":{"fontSize":"var:preset|font-size|base"}},"textColor":"viceunf-secondary"} -->
            <h5 class="wp-block-heading has-viceunf-secondary-color has-text-color">Navegación</h5>
            <!-- /wp:heading -->
        ...
        <div class="wp-block-column" style="flex-basis:23.33%">
            <!-- wp:heading {"level":5,"style":{"typography":{"fontSize":"var:preset|font-size|base"}},"textColor":"viceunf-secondary"} -->
            <h5 class="wp-block-heading has-viceunf-secondary-color has-text-color">Investigación</h5>
            <!-- /wp:heading -->
            <!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|sm"}},"textColor":"white"} -->
        ...
        <div class="wp-block-column" style="flex-basis:23.33%">
            <!-- wp:heading {"level":5,"style":{"typography":{"fontSize":"var:preset|font-size|base"}},"textColor":"viceunf-secondary"} -->
            <h5 class="wp-block-heading has-viceunf-secondary-color has-text-color">Contacto</h5>
            <!-- /wp:heading -->
            <!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|sm"}},"textColor":"white"} -->
    ...
    <!-- wp:separator {"backgroundColor":"viceunf-legacy-pri2","style":{"spacing":{"margin":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|40"}}}} -->
    <hr class="wp-block-separator has-text-color has-viceunf-legacy-pri2-color has-alpha-channel-opacity has-viceunf-legacy-pri2-background-color has-background"/>
    <!-- /wp:separator -->
