...
if (is_singular() && has_post_thumbnail()) {
	...
	$viceunf_breadcrumb_bg_img = get_theme_mod('viceunf_breadcrumb_bg_img', esc_url(get_stylesheet_directory_uri() . '/assets/images/background/page_title.webp'));
}
	...
	<section id="dt_pagetitle" class="dt_pagetitle dt-text-center">
		...
		<div class="dt-container">
			<div class="dt_pagetitle_content">
				<?php if ('yoast' === $viceunf_breadcrumb_type && function_exists('yoast_breadcrumb')) :  call_user_func('yoast_breadcrumb'); ?>
				<?php elseif ('rankmath' === $viceunf_breadcrumb_type && function_exists('rank_math_the_breadcrumbs')) :  call_user_func('rank_math_the_breadcrumbs'); ?>
				<?php elseif ('navxt' === $viceunf_breadcrumb_type && function_exists('bcn_display')) :  call_user_func('bcn_display');
				else: ?>
