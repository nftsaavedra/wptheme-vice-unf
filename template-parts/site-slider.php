...
?>
    <section id="dt_slider" class="dt_slider dt_slider--five dt_slider--thumbnav dt_slider--kenburn">
        <div class="swiper dt_swiper_carousel slider" data-swiper-options='<?php echo json_encode([
                                                                                "loop" => ($slider_query->post_count > 1),
                                                                                "slidesPerView" => 1,
                                                                                "spaceBetween" => 0,
                                                                                "speed" => 1000,
                                                                                ...
                                                                                "navigation" => ["nextEl" => "#dt_slider .swiper-button-next", "prevEl" => "#dt_slider .swiper-button-prev"],
                                                                                "breakpoints" => [
                                                                                    "0" => ["slidesPerView" => 1],
                                                                                    "600" => ["slidesPerView" => 1],
                                                                                    "992" => ["slidesPerView" => 1]
