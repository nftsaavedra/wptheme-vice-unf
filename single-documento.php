              ...
              ?>
                <div class="viceunf-single-doc__media">
                  <?php if ($is_pdf) : ?>
                    ...
                    <div class="viceunf-single-doc__preview" style="margin-bottom: 2.5rem; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); background-color: #f8fafc;">
                      <iframe
                        src="<?php echo esc_url($file_url); ?>#toolbar=0&navpanes=0&scrollbar=0&view=FitH"
                        title="Vista previa de <?php echo esc_attr(get_the_title()); ?>"
                        style="width: 100%; height: 85vh; min-height: 600px; border: none; display: block;">
                      </iframe>
                    </div>
                  <?php endif; ?>
